...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'hanako@v8ncw.onmicrosoft.com',
  ...
  links: [
    {
      name: 'Blog',
      link: 'https://hanako.me',
    },
    {
      name: 'GitHub',
      link: 'https://github.com/hanakokoizumi',
    },
  ],
